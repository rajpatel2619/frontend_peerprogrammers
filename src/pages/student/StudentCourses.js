...
const StudentCourses = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6 pb-16 relative flex">
      <StudentSidebar />
      <div className="flex-1">
        ...
        <p className="text-center text-gray-600 dark:text-gray-400 text-base max-w-3xl mx-auto mt-10 border-0 shadow-none">
          Browse through a wide selection of beginner to advanced courses
          designed to help you grow your skills. Whether you're starting out or
          looking to specialize, there's something for everyone.
          <a
            href="#"
